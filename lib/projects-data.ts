...
export const projectsData: Project[] = [
  ...
  },
  {
    ...
    techStack: {
      frontend: ['Next.js', 'TypeScript', 'Tailwind CSS'],
      backend: ['Sanity', 'Stripe'],
      devops: ['Vercel'],
      database: ['Sanity'],
      tools: ['Figma', 'Framer Motion'],
    },
    featuredImage:
      'https://res.cloudinary.com/duxjoty1l/image/upload/v1752942476/Screenshot_4_brzohh.png',
    images: [
      'https://res.cloudinary.com/duxjoty1l/image/upload/v1752942479/Screenshot_5_h3znph.png',
      'https://res.cloudinary.com/duxjoty1l/image/upload/v1752942543/screencapture-youngsproutstherapy-parenting-counselling-2025-07-19-22_05_38_xuxcxe.png',
    ],
