...
import { Mail, Heart, ArrowUp, Code, Coffee } from 'lucide-react';
      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10'>
        <div className='grid md:grid-cols-4 gap-12'>
          ...
          >
            ...
            <p className='text-muted-foreground text-lg leading-relaxed mb-6 max-w-md'>
              ...
              that make a difference. Always learning, always building, always
              improving.
            </p>
        ...
        >
          <div className='flex items-center gap-2 text-muted-foreground text-sm'>
            <span>
              © {new Date().getFullYear()} Sazzad Hossain. Crafted with
            </span>
